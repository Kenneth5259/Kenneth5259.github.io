    ...
    <div className="about__upper">
        <div className="about__upper__body">
            ...
            <div className="about__upper__body__buttons">
                <div className="about__upper__body__buttons__portfolio" onClick={()=>{props.setActiveNav('portfolio')}}><div className="about__upper__body__buttons__icon"><FontAwesomeIcon icon={faArrowCircleRight} size='1x'/></div>Portfolio</div>
